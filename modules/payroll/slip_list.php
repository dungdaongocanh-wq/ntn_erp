...
$totalKpiBonus = array_sum(array_column($slips, 'kpi_bonus'));      // ✅ THÊM
$totalKpiDeduct= array_sum(array_column($slips, 'kpi_deduction'));  // ✅ THÊM
        ...
        <table class="slip-table" id="slipTable">
            <thead>
                <tr class="group-row">
                    ...
                    <th colspan="2" class="grp-kpi">KPI</th><!-- ✅ THÊM nhóm KPI -->
            ...
            <tr class="<?= $rowClass ?>">
                ...
                <!-- Trợ cấp -->
                <?php foreach (['meal_received','clothes_received','phone_received','transport_received'] as $f): ?>
                <td class="text-end"><?= (float)$s[$f] > 0 ? number_format((float)$s[$f]) : '<span class="c-muted">—</span>' ?></td>
                <?php endforeach; ?>
...
.grp-kpi       { background: #e0f2fe !important; } /* ✅ màu nhóm KPI */
