...
const BASE = {
    ...
    kpi_bonus        : <?= (float)($slip['kpi_bonus'] ?? 0) ?>,   // ✅ KPI bonus
    ...
    kpi_deduction    : <?= (float)($slip['kpi_deduction'] ?? 0) ?>,  // ✅ KPI deduction
};
...
function recalc() {
    ...
    const gross = BASE.basic_received
                + BASE.meal + BASE.clothes + BASE.phone + BASE.transport
                + BASE.attendance_bonus + BASE.ot + BASE.kpi_bonus   // ✅ cộng kpi_bonus
                + BASE.annual_leave
    ...
    const net = gross
              ...
              - pitAdj
              - BASE.late_deduction
              - BASE.kpi_deduction   // ✅ trừ kpi_deduction
              - advance;
